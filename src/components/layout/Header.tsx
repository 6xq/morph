export function Header() {
  return (
    <header className="px-6 sm:pl-12 sm:pr-16 lg:pr-32 pt-8 sm:pt-10 pb-6 flex flex-col sm:flex-row items-start justify-between gap-4 sm:gap-0 flex-shrink-0">
