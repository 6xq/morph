export function Footer({ onSendClick }: { onSendClick: () => void }) {
  return (
    <footer className="px-6 sm:px-12 py-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-0 border-t border-black/10 flex-shrink-0">
